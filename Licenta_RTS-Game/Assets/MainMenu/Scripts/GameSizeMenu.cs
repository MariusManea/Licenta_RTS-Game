...
public class GameSizeMenu : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        float topPos = menuHeight - 2 * (ResourceManager.Padding + ResourceManager.ButtonHeight);
        ...
        {
            PlayClick();
            GetComponent<GameSizeMenu>().enabled = false;
