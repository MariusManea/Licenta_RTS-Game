...
namespace RTS
{
    ...
    public enum UpgradeableObjects { CityHall, University, WarFactory, Refinery, Worker, Harvester, OilPump, Tank, BatteringRam, Dock, CargoShip, Turret, Wonder, ConvoyTruck }
}
